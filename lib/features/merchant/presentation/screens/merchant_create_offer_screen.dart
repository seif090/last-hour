        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              Text('Category', style: AppTextStyles.labelLarge.copyWith(fontWeight: FontWeight.w600)),
              ...
              const SizedBox(height: 16),
              Text('Pickup Window', style: AppTextStyles.labelLarge.copyWith(fontWeight: FontWeight.w600)),
              const SizedBox(height: 8),
              Row(
                children: [
                  Expanded(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('Add Photo', style: AppTextStyles.labelLarge.copyWith(fontWeight: FontWeight.w600)),
            Text('Tap to upload an image', style: AppTextStyles.caption),
          ],
        ),
      ),
    );
