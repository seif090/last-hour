...
public class OffersController : ControllerBase
{
    ...
    [HttpGet("featured")]
    public async Task<IActionResult> GetFeatured([FromQuery] int page = 1, [FromQuery] int pageSize = 10)
    {
    ...
    public async Task<IActionResult> GetByCategory(string category, [FromQuery] int page = 1, [FromQuery] int pageSize = 20)
    {
    ...
    [HttpGet("nearby")]
    public async Task<IActionResult> GetNearby([FromQuery] double latitude, [FromQuery] double longitude, [FromQuery] double radiusKm = 5)
    {
